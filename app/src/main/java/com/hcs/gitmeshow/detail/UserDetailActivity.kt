package com.hcs.gitmeshow.detail
...
import com.hcs.gitmeshow.databinding.ActivityUserDetailBinding
import com.hcs.gitmeshow.pager.ViewPagerAdapter
import com.hcs.gitmeshow.settings.SettingsActivity
...
import com.hcs.gitmeshow.viewUtils.toast
...
class UserDetailActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.menu_favorite -> startActivity(
                Intent(
                    this, Class.forName("com.aditprayogo.favorite.ui.FavoriteUserActivity")
                )
            )
    ...
    private fun handleStateLoading(loading: LoaderState) = if (loading is LoaderState.ShowLoading) {
